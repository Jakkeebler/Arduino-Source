...
const std::map<std::string, TestFunction> TEST_MAP = {
    ...
    {"PokemonFRLG_PartySummaryReader_Dex", std::bind(image_int_detector_helper, test_pokemonFRLG_PartySummaryReader_dex, _1)},
    {"PokemonFRLG_PartySummaryReader_Moves", std::bind(image_words_detector_helper, test_pokemonFRLG_PartySummaryReader_moves, _1)},
